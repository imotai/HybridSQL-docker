...
# leveldb
fetch https://github.com/google/leveldb/archive/refs/tags/1.20.tar.gz leveldb-1.20.tar.gz
# openssl
...
# abseil
fetch https://github.com/abseil/abseil-cpp/archive/20200923.3.tar.gz abseil-cpp-20200923.3.tar.gz
# bison
...
# thirft
fetch http://archive.apache.org/dist/thrift/0.13.0/thrift-0.13.0.tar.gz thrift-0.13.0.tar.gz
...
# incubator brpc
fetch https://github.com/apache/incubator-brpc/archive/refs/tags/0.9.7.tar.gz incubator-brpc-0.9.7.tar.gz
...
# zookeeper
fetch https://archive.apache.org/dist/zookeeper/zookeeper-3.5.7/apache-zookeeper-3.5.7.tar.gz apache-zookeeper-3.5.7.tar.gz
